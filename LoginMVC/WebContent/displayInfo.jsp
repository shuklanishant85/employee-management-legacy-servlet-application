<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.beans.Employee" %>
...
form button[type=submit] {
 ...
 </head> <body  style="color:white; font-size:30px;" >  <div id="bg"> 
 <!-- part of view -->
  <% Employee user = (Employee) (session.getAttribute("currentSessionUser"));%> 
<h3>The required information of the user is:</h3><br>
 <h4> Name :<%= user.getFirstName() + " " + user.getLastName() %> <br>
  Employee ID: <%= user.getId() %> <br>
  Salary: <%= user.getSalary() %><br>
  Address:<%= user.getAddress() %><br>
  Gender: <%= user.getGender() %><br>
  Contact: <%= user.getPhoneNo() %><br>
  Status: <%= user.getStatus() %><br>
   </h4>
  <center><h4>TO RETURN TO HOME <a href="Admin.jsp">CLICK HERE</a></h4></center>
