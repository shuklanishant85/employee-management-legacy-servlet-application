...
<body background="Desert.jpg" style="color:white;">
<!-- Part of view -->
	<form action="UpdateServ">
	<center>
	UPDATE THE DATA OF THE EMPLOYEE.
		<fieldset>
			<legend>ENTER UPDATED INFO</legend>
			Please enter your First name <input type="text" name="fn"/> <br> <br>
			Please enter your Last name <input type="text" name="ln"/> <br> <br>
			Please enter your Id <input type="text" name="id" /> <br> <br>
			Please enter your Address <input type="text" name="ad"/> <br> <br>
			Please enter your Phone No. <input type="text" name="ph"/> <br> <br>
			Please enter your Gender <input type="text" name="ge"/> <br> <br>
			Please enter your Status <input type="text" name="st"/> <br> <br>
			Please enter Salary <input type="text" name="sal"/>  <br> <br>
