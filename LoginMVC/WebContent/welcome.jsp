...
<body  style="color:white; "><div id="bg">
	<center>
		<form name="addem"  method="get">

			<br>
			<p>
				<input type="button" onclick="fun()" name="ae" value="Add Employee" />
			</p>
			
			<br>
			<p>
				<input type="button" onclick="fun4()" name="de" value="Delete Employee" />
			</p>

			<br>
			<p>
				<input type="button" onclick="fun2()" name="ue" value="Update Employee" />
			</p>


			<br>
			<p>
				<input type="button" onclick="fun3()" name="dise" value="Display Employee" />
			</p>
